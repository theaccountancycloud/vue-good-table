...
var __vue_render__$3 = function __vue_render__() {
  ...
  return _vm.hasFilterRow ? _c('tr', [_vm.lineNumbers ? _c('th') : _vm._e(), _vm._v(" "), _vm.selectable ? _c('th') : _vm._e(), _vm._v(" "), _vm._l(_vm.columns, function (column, index) {
    ...
    })], 2) : _vm._e(), _vm._v(" "), _vm.isMultiselectDropdown(column) === 'manual' ? _c('vue-select', {
    ...
    }) : _vm._e(), _vm._v(" "), _vm.isMultiselectDropdown(column) === 'auto' ? _c('vue-select', {
      ref: 'vgt-multiselect' + column.label + index,
      refInFor: true,
      attrs: {
...
var __vue_scope_id__$3 = "data-v-77892b16";
/* module identifier */
...
var script$6 = {
  ...
  methods: {
    returnWatchObj: function returnWatchObj() {
      var _this2 = this;

      lodash_debounce(function () {
        _this2.$emit('update:isLoading', false);

        _this2.filterRows(_this2.columnFilters, false);
      }, 1000);
    },
    ...
    filterRows: function filterRows(columnFilters) {
      ...
      console.log('from filter ' + fromFilter); // if (!fromFilter) return;
